...
<div class="content-gol">
    <div class="filtros">
            <form method="get" action="goles_totales.php">
                <select name="ordenar" onchange="this.form.submit()">
                    <option value="">Ordenar por</option>
                    <option value="alfabetico2" <?php echo (isset($_GET['ordenar']) && $_GET['ordenar'] == 'alfabetico2') ? 'selected' : ''; ?>>Equipo</option>
        ...
        <div class="contenedor-videos">
                ...
                WHERE  equipo_rival LIKE '%$buscar%' OR titulo LIKE '%$buscar%' OR e.nombre_equipo LIKE '%$buscar%'";
                ...
                if ($orden === 'alfabetico2') {
                    $sqlvideos .= " ORDER BY e.nombre_equipo ASC";
                }
